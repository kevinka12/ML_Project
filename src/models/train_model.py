...
def get_training_config():
    ...
    data_gold_path = "notebooks/artifacts/train_data_gold.csv"
    data_version = "00000"
...
def evaluate_model(model_grid, X_train, y_train, X_test, y_test):
    best_model_xgb_params = model_grid.best_params_
    print("Best xgboost params")
    pprint(best_model_xgb_params)
    ...
    return best_model_xgb_params, y_pred_train, y_pred_test
...
def save_best_xgboost_model(model_grid, y_train, y_pred_train):
    ...
    xgboost_model_path = "notebooks/artifacts/lead_model_xgboost.json"
...
def train_logistic_regression(
    ...
    with mlflow.start_run(experiment_id=experiment_id):
        ...
        lr_model_path = "notebooks/artifacts/lead_model_lr.pkl"
        ...
        mlflow.log_artifacts("notebooks/artifacts", artifact_path="model")
...
def save_artifacts(X_train, model_results):
    column_list_path = "notebooks/artifacts/columns_list.json"
    ...
    model_results_path = "notebooks/artifacts/model_results.json"
...
def select_best_model(experiment_name):
    ...
    with open("notebooks/artifacts/model_results.json", "r") as f:
